...
<html lang="en">
  <head>
	...
	<title>Beverages Admin | Edit Beverage</title>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" method="POST" action="{{ route('updateBeverages', $beverage->id) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
										@csrf
										@method('put')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="title" required="required" name="title" value="{{ old('title', $beverage->title) }}"class="form-control ">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="content" value="{{ old('content', $beverage->content) }}" required="required" class="form-control">Contents</textarea>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="price" class="form-control" name="price" value="{{ old('price', $beverage->price) }}" required="required">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name="published" value="{{ old('published, $beverage->published') }}"  class="flat">
												</label>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name="is_special" value="{{ old('is_special, $beverage->is_special') }}" class="flat">
												</label>
											</div>
										</div>
										<div class="item form-group">
