					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" method="POST" action="{{ route('addNewBeverage') }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
										@csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="price" class="form-control"  name="price" value="{{ old('Price') }}" required="required">
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name="published" {{ old('published') ? 'checked' : '' }} class="flat">
												</label>
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" name="is_special" {{ old('is_special') ? 'checked' : '' }} class="flat">
												</label>
											</div>
										</div>
										<div class="item form-group">
