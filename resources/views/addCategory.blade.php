...
<html lang="en">
  <head>
	...
	<title>Beverages Admin | Add Category</title>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" method="POST" action="{{ route('addCategories') }}" data-parsley-validate class="form-horizontal form-label-left">
										@csrf
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="add-category" name="category_name" required="required" value="{{ old('category_name') }}" class="form-control ">
											</div>
										</div>
